    ...
    <header className="bg-gradient-to-br from-neutral-900 via-neutral-900 to-black border-b-4 border-amber-400">
      <div className="max-w-[1104px] mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          {/* Telegram CTA - visible on all screens */}

          <a href="https://t.me/bigbetenergy"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-amber-400 hover:bg-amber-300 text-black font-bold text-sm px-4 py-2 rounded transition"
          >
