    ...
    <div className="bg-neutral-900 border-2 border-amber-400 rounded-lg p-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <a
          ...
          className="flex-shrink-0 bg-amber-400 hover:bg-amber-300 text-black font-bold text-sm px-4 py-2 rounded transition-all hover:scale-105 hover:shadow-[0_0_20px_rgba(251,191,36,0.5)]"
        >
          {buttonText}
        </a>
      </div>
